...
def main():
    # Paths
    testing_images_dir = os.path.join(config.BASE_DIR, 'data', 'testing_images')
    output_images_dir = os.path.join(config.BASE_DIR, 'data', 'output_images')
